...
export default function Cart({ open, onClose }: CartProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 z-[70] h-dvh w-full max-w-md bg-[#0C0C0C] border-l border-[#D7E2EA]/10 transform transition-transform duration-300 flex flex-col ${
          open ? "translate-x-0" : "translate-x-full"
        }`}
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-[#D7E2EA]/10 flex-shrink-0">
        ...
        {items.length > 0 && (
          <div className="border-t border-[#D7E2EA]/10 p-6 space-y-3 flex-shrink-0">
